            ...
            <div className='obrigadoMainSection-box'>
                ...
                <div className='obrigadoMainSection-box-cards'>
                    <div className='obrigadoMainSection-card'>
                        ...
                        <img src='./obrigado_icone_3.png' alt='icone de e-mail'/>
                        <p>Abra seu e-mail e confira se recebeu a confirmação de sua inscrição.</p>
                    </div>
                    <div className='obrigadoMainSection-card'>
                        <h1>Passo 2</h1>
                        <h2>com dúvida?<br/>Acione nosso suport!</h2>
                        <img src='./obrigado_icone_2.png' alt='icone do suport'/>
                        <p>Caso tenha alguma dúvida ou precise de suporte fale conosco pelo telefone: <strong>(11) 3257-1717</strong></p>
                    </div>
                    <div className='obrigadoMainSection-card'>
                        <h1>Passo 3</h1>
                        <h2>Não perca a chance de ver o nosso DIY</h2>
                        <a href='BOOK_DIY_BELA_VISTA.pdf' target="_blank"><img className='buzz-out-on-hover' src='./obrigado_icone_1.png' alt='icone para download do book'/></a>
                        <p>Aproveite seu interesse e baixe o book do empreendimento<br/><strong>(clique no icone</strong>)</p>
                    </div>
                </div>
            </div>
        </div>
